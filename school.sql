...
INSERT INTO `grado` VALUES (1,'Kinder',1),(2,'Inicial',1),(3,'Primaria',1),(4,'Secundaria',1);
...
CREATE TABLE `turnos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `turnos` varchar(20) DEFAULT NULL,
...
INSERT INTO `turnos` VALUES (1,'Día',1),(2,'Tarde',1),(3,'Noche',1);
...
INSERT INTO `zona` VALUES (1,'Urbana',1),(2,'Rural',1);
